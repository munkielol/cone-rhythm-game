...
{
    /// <summary>
    /// Production Catch note head renderer. Geometry-first (v0 step 1):
    ...
    public class CatchNoteRenderer : MonoBehaviour
    {
        ...
        [Tooltip("Radial half-thickness of the catch head trapezoid in PlayfieldLocal units. " +
        ...
        private void Awake()
        {
            ...
            {
                _meshPool[i] = BuildTrapezoidMesh("CatchNoteTrapezoid");
            }
